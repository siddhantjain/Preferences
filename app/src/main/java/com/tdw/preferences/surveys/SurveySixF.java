 ...
 */
public class SurveySixF extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survey_six_f);
        ...
        /*SeekBar Computation*/
        mSlider1 = (SeekBar) findViewById(R.id.sbGame6FSlider1);
        mSlider1InitialValue = (TextView) findViewById(R.id.tvGame6FSlider1Left);
        mSlider1FinalValue = (TextView) findViewById(R.id.tvGame6FSlider1Right);
        mSlider1ExchangeRateValue  = (TextView) findViewById(R.id.tvGame6FSlider1Center);

        mSlider2 = (SeekBar) findViewById(R.id.sbGame6FSlider2);
        mSlider2InitialValue = (TextView) findViewById(R.id.tvGame6FSlider2Left);
        mSlider2FinalValue = (TextView) findViewById(R.id.tvGame6FSlider2Right);
        mSlider2ExchangeRateValue  = (TextView) findViewById(R.id.tvGame6FSlider2Center);

        mSlider3 = (SeekBar) findViewById(R.id.sbGame6FSlider3);
        mSlider3InitialValue = (TextView) findViewById(R.id.tvGame6FSlider3Left);
        mSlider3FinalValue = (TextView) findViewById(R.id.tvGame6FSlider3Right);
        mSlider3ExchangeRateValue  = (TextView) findViewById(R.id.tvGame6FSlider3Center);

        mSlider4 = (SeekBar) findViewById(R.id.sbGame6FSlider4);
        mSlider4InitialValue = (TextView) findViewById(R.id.tvGame6FSlider4Left);
        mSlider4FinalValue = (TextView) findViewById(R.id.tvGame6FSlider4Right);

        mSlider5 = (SeekBar) findViewById(R.id.sbGame6FSlider5);
        mSlider5InitialValue = (TextView) findViewById(R.id.tvGame6FSlider5Left);
        mSlider5FinalValue = (TextView) findViewById(R.id.tvGame6FSlider5Right);

        mSlider6 = (SeekBar) findViewById(R.id.sbGame6FSlider6);
        mSlider6InitialValue = (TextView) findViewById(R.id.tvGame6FSlider6Left);
        mSlider6FinalValue = (TextView) findViewById(R.id.tvGame6FSlider6Right);
    ...
    public void startNextGame (View view) throws IOException {
        ...
        DataStore.setSurveySixFResult(gr);
        Intent intent = new Intent(SurveySixF.this,WelcomeScreen.class);
