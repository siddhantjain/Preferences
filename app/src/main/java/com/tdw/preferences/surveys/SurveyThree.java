...
public class SurveyThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTVSlider1LaterDate.setText(Integer.toString(5) + " ஆம் நாளுக்கான ரீசார்ஜ்");
        mTVSlider2SoonerDate.setText(Integer.toString(numDaysToSoonerDate) + " ஆம் நாளுக்கான ரீசார்ஜ்");
        mTVSlider2LaterDate.setText(Integer.toString(3) + " ஆம் நாளுக்கான ரீசார்ஜ்");
        mTVSlider3SoonerDate.setText(Integer.toString(numDaysToSoonerDate) + " ஆம் நாளுக்கான ரீசார்ஜ்");
        mTVSlider3LaterDate.setText(Integer.toString(2) + " ஆம் நாளுக்கான ரீசார்ஜ்");
        mTVSlider4SoonerDate.setText(Integer.toString(numDaysToSoonerDate) + " ஆம் நாளுக்கான ரீசார்ஜ்");
        mTVSlider4LaterDate.setText(Integer.toString(1) + " ஆம் நாளுக்கான ரீசார்ஜ்");

        /*SeekBar Computation*/
        mSlider1 = (SeekBar) findViewById(R.id.sbGame3Slider1);
        mSlider1InitialValue = (TextView) findViewById(R.id.tvGame3Slider1Left);
        mSlider1FinalValue = (TextView) findViewById(R.id.tvGame3Slider1Right);

        mSlider2 = (SeekBar) findViewById(R.id.sbGame3Slider2);
        mSlider2InitialValue = (TextView) findViewById(R.id.tvGame3Slider2Left);
        mSlider2FinalValue = (TextView) findViewById(R.id.tvGame3Slider2Right);

        mSlider3 = (SeekBar) findViewById(R.id.sbGame3Slider3);
        mSlider3InitialValue = (TextView) findViewById(R.id.tvGame3Slider3Left);
        mSlider3FinalValue = (TextView) findViewById(R.id.tvGame3Slider3Right);

        mSlider4 = (SeekBar) findViewById(R.id.sbGame3Slider4);
        mSlider4InitialValue = (TextView) findViewById(R.id.tvGame3Slider4Left);
        mSlider4FinalValue = (TextView) findViewById(R.id.tvGame3Slider4Right);

        mSlider5 = (SeekBar) findViewById(R.id.sbGame3Slider5);
        mSlider5InitialValue = (TextView) findViewById(R.id.tvGame3Slider5Left);
        mSlider5FinalValue = (TextView) findViewById(R.id.tvGame3Slider5Right);

        mSlider6 = (SeekBar) findViewById(R.id.sbGame3Slider6);
        mSlider6InitialValue = (TextView) findViewById(R.id.tvGame3Slider6Left);
        mSlider6FinalValue = (TextView) findViewById(R.id.tvGame3Slider6Right);
