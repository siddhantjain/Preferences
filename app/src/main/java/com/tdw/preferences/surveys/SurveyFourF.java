 ...
 */
public class SurveyFourF extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survey_four_f);
        ...
        mCalendar = (CalendarPickerView) findViewById(R.id.cvGame4FCurrentMonth);
        mTVSoonerDate = (TextView) findViewById(R.id.tvGame4FSoonerDateLabel);
        mTVLaterDate = (TextView) findViewById(R.id.tvGame4FLaterDateLabel);
        ...
        /*SeekBar Computation*/
        mSlider1 = (SeekBar) findViewById(R.id.sbGame4FSlider1);
        mSlider1InitialValue = (TextView) findViewById(R.id.tvGame4FSlider1Left);
        mSlider1FinalValue = (TextView) findViewById(R.id.tvGame4FSlider1Right);
        mSlider1ExchangeRateValue  = (TextView) findViewById(R.id.tvGame4FSlider1Center);

        mSlider2 = (SeekBar) findViewById(R.id.sbGame4FSlider2);
        mSlider2InitialValue = (TextView) findViewById(R.id.tvGame4FSlider2Left);
        mSlider2FinalValue = (TextView) findViewById(R.id.tvGame4FSlider2Right);
        mSlider2ExchangeRateValue  = (TextView) findViewById(R.id.tvGame4FSlider2Center);

        mSlider3 = (SeekBar) findViewById(R.id.sbGame4FSlider3);
        mSlider3InitialValue = (TextView) findViewById(R.id.tvGame4FSlider3Left);
        mSlider3FinalValue = (TextView) findViewById(R.id.tvGame4FSlider3Right);
        mSlider3ExchangeRateValue  = (TextView) findViewById(R.id.tvGame4FSlider3Center);

        mSlider4 = (SeekBar) findViewById(R.id.sbGame4FSlider4);
        mSlider4InitialValue = (TextView) findViewById(R.id.tvGame4FSlider4Left);
        mSlider4FinalValue = (TextView) findViewById(R.id.tvGame4FSlider4Right);

        mSlider5 = (SeekBar) findViewById(R.id.sbGame4FSlider5);
        mSlider5InitialValue = (TextView) findViewById(R.id.tvGame4FSlider5Left);
        mSlider5FinalValue = (TextView) findViewById(R.id.tvGame4FSlider5Right);

        mSlider6 = (SeekBar) findViewById(R.id.sbGame4FSlider6);
        mSlider6InitialValue = (TextView) findViewById(R.id.tvGame4FSlider6Left);
        mSlider6FinalValue = (TextView) findViewById(R.id.tvGame4FSlider6Right);
    ...
    public void startNextGame (View view) throws IOException {
        ...
        gameResult gr = new gameResult(mSlider1InitialValue.getText().toString(),mSlider1FinalValue.getText().toString(),"","","","","","","","","","");
        DataStore.setSurveyFourFResult(gr);
        //Intent intent = new Intent(SurveyFourF.this,SurveyFiveF.class);
        //startActivity(intent);
        SurveyResults sr = new SurveyResults();
        sr.writeToFile();

        //start-over
        Intent intent = new Intent(SurveyFourF.this,WelcomeScreen.class);
