...
public class SurveyFive extends AppCompatActivity {
    ...
    final int GAME_NUMBER = 5;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_survey_five);
        ...
        mCalendar = (CalendarPickerView) findViewById(R.id.cvGame5CurrentMonth);
        ...
        /*SeekBar Computation*/
        mSlider1 = (SeekBar) findViewById(R.id.sbGame5Slider1);
        mSlider1InitialValue = (TextView) findViewById(R.id.tvGame5Slider1Left);
        mSlider1FinalValue = (TextView) findViewById(R.id.tvGame5Slider1Right);

        mSlider2 = (SeekBar) findViewById(R.id.sbGame5Slider2);
        mSlider2InitialValue = (TextView) findViewById(R.id.tvGame5Slider2Left);
        mSlider2FinalValue = (TextView) findViewById(R.id.tvGame5Slider2Right);

        mSlider3 = (SeekBar) findViewById(R.id.sbGame5Slider3);
        mSlider3InitialValue = (TextView) findViewById(R.id.tvGame5Slider3Left);
        mSlider3FinalValue = (TextView) findViewById(R.id.tvGame5Slider3Right);

        mSlider4 = (SeekBar) findViewById(R.id.sbGame5Slider4);
        mSlider4InitialValue = (TextView) findViewById(R.id.tvGame5Slider4Left);
        mSlider4FinalValue = (TextView) findViewById(R.id.tvGame5Slider4Right);

        mSlider5 = (SeekBar) findViewById(R.id.sbGame5Slider5);
        mSlider5InitialValue = (TextView) findViewById(R.id.tvGame5Slider5Left);
        mSlider5FinalValue = (TextView) findViewById(R.id.tvGame5Slider5Right);

        mSlider6 = (SeekBar) findViewById(R.id.sbGame5Slider6);
        mSlider6InitialValue = (TextView) findViewById(R.id.tvGame5Slider6Left);
        mSlider6FinalValue = (TextView) findViewById(R.id.tvGame5Slider6Right);
